...
class ParkingModelImageScreen3 extends StatefulWidget {
  final String fileName; // Allow dynamic file name assignment

  const ParkingModelImageScreen3({Key? key, this.fileName = 'parkingmodel3'})
...
class _ParkingModelImageScreenState extends State<ParkingModelImageScreen3> {
